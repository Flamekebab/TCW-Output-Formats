...
def main(): 
    ...
    def transcode_all():
        ...
        tcw_tools.ffmpeg_audio_transcode(
            input_file, output_path, output_file_name, "opus", "24000", "1"
        )
        tcw_tools.ffmpeg_audio_transcode(
            input_file, output_path, output_file_name, "mp3", "5.5", "2"
        )
        tcw_tools.ffmpeg_audio_transcode(
            input_file, output_path, output_file_name, "m4a", "3", "2"
        )
        tcw_tools.ffmpeg_audio_transcode(
            input_file, output_path, output_file_name, "ogg", "-0.1", "1"
        )
